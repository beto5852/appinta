       ...
       <form action="#" method="get" class="sidebar-form">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" {{request()->is('admin/tags') ? 'active': ''}}>
                ...
                <li class="treeview" {{request()->is('admin/reportes') ? 'active': ''}}>
                    <a href="">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="active"><a href="{{asset('admin/reportes')}}" onclick="cargarlistado(4,1);" ><i class="fa fa-circle-o"></i> Graficas </a></li>
