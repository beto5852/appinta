...
<section id="clients">
    <div class="container">
        ...
        <div class="row wow fadeInUp">
            ...
            <div class="col-md-2">
                <a href="http://www.marena.gob.ni/" target="_blank"> <img src="{{asset('template/img/clients/client-1.png')}}" alt=""></a>
            </div>

            <div class="col-md-2">
                <a href="http://www.economiafamiliar.gob.ni/" target="_blank"><img src="{{asset('template/img/clients/client-2.png')}}" alt=""></a>
            </div>

            <div class="col-md-2">
                <a href="http://www.ipsa.gob.ni/" target="_blank"> <img src="{{asset('template/img/clients/client-3.png')}}" alt=""></a>
            </div>

            <div class="col-md-2">
                <a href="http://www.ineter.gob.ni/" target="_blank"> <img src="{{asset('template/img/clients/client-4.png')}}" alt=""></a>
            </div>

            <div class="col-md-2">
                <a href="http://canal6.com.ni/" target="_blank"> <img src="{{asset('template/img/clients/client-5.png')}}" alt=""></a>
            </div>

            <div class="col-md-2">
                <a href="https://www.el19digital.com/" target="_blank"> <img src="{{asset('template/img/clients/client-6.png    ')}}" alt=""></a>
            </div>
